...
<div class="m-list-search__results">
	...
	<a href="#" class="m-list-search__result-item">
		<span class="m-list-search__result-item-pic"><img class="m--img-rounded" src="<?php echo Page::getAssetsPath() ?>app/media/img/users/user1.jpg" title=""/></span>
		<span class="m-list-search__result-item-text">Amanda Anderson</span>
	</a>
	<a href="#" class="m-list-search__result-item">
		<span class="m-list-search__result-item-pic"><img class="m--img-rounded" src="<?php echo Page::getAssetsPath() ?>app/media/img/users/user2.jpg" title=""/></span>
		<span class="m-list-search__result-item-text">Kennedy Lloyd</span>
	</a>
	<a href="#" class="m-list-search__result-item">
		<span class="m-list-search__result-item-pic"><img class="m--img-rounded" src="<?php echo Page::getAssetsPath() ?>app/media/img/users/user3.jpg" title=""/></span>
		<span class="m-list-search__result-item-text">Megan Weldon</span>
	</a>
	<a href="#" class="m-list-search__result-item">
		<span class="m-list-search__result-item-pic"><img class="m--img-rounded" src="<?php echo Page::getAssetsPath() ?>app/media/img/users/user4.jpg" title=""/></span>
