...
var KDashboard = function() {
    ...
    var mediumCharts = function() {
        KLib.initMediumChart('k_widget_mini_chart_1', [20, 90, 20, 10, 20, 35, 20, 25, 10, 10], 70, KApp.getStateColor('brand'));
        KLib.initMediumChart('k_widget_mini_chart_2', [10, 15, 25, 90, 15, 30, 10, 40, 15, 25], 70, KApp.getStateColor('danger'));
    ...
    var generalStatistics = function() {
        // Mini charts
        KLib.initMiniChart($('#k_widget_general_statistics_chart_1'), [6, 8, 3, 18, 15, 7, 100, 7], KApp.getStateColor('warning'), 2, false, false);
        KLib.initMiniChart($('#k_widget_general_statistics_chart_2'), [8, 6, 9, 18, 15, 7, 100, 16], KApp.getStateColor('brand'), 2, false, false);
        KLib.initMiniChart($('#k_widget_general_statistics_chart_3'), [4, 12, 9, 18, 15, 7, 100, 12], KApp.getStateColor('danger'), 2, false, false);
    ...
    var widgetTotalOrdersChart = function() {
        ...
        var data = [80, 35, 45, 65, 35, 50, 40, 60, 35, 45];
