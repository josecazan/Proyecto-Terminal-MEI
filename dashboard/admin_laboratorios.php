...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Administrador | Laboratorios</title>
						...
						<div id="k_aside_menu" class="k-aside-menu " data-kmenu-vertical="1" data-kmenu-scroll="1" data-kmenu-dropdown-timeout="500">
							<ul class="k-menu__nav ">
								...
								<li class="k-menu__item  k-menu__item--submenu" aria-haspopup="true" data-kmenu-submenu-toggle="hover"><a href="javascript:;" class="k-menu__link k-menu__toggle"><i class="k-menu__link-icon flaticon2-browser-1"></i><span class="k-menu__link-text">Laboratorios</span><i class="k-menu__ver-arrow la la-angle-right"></i></a>
									<div class="k-menu__submenu "><span class="k-menu__arrow"></span>
										<ul class="k-menu__subnav">
											<li class="k-menu__item " aria-haspopup="true"><a href="admin_laboratorios.php" class="k-menu__link "><i class="k-menu__link-bullet k-menu__link-bullet--dot"><span></span></i><span class="k-menu__link-text">Laboratorios</span></a></li>
										</ul>
									</div>
								</li>
					...
					<div class="k-content	k-grid__item k-grid__item--fluid k-grid k-grid--hor" id="k_content">
						...
						<div class="k-content__head	k-grid__item">
							<div class="k-content__head-main">
								<h3 class="k-content__head-title">Laboratorios</h3>
						...
						<div class="k-portlet">
									<div class="k-portlet__head">
										<div class="k-portlet__head-label">
											<h3 class="k-portlet__head-title">Añadir Laboratorio</h3>
										</div>
									</div>

									<!--begin::Form-->
									<form class="k-form" action="metodos/NuevoLaboratorio.php" method="POST">
										<div class="k-portlet__body">

											<div class="form-group">
												<label>Nombre del laboratorio</label>
												<input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Nombre del laboratorio" name="NombreLaboratorio">
											</div>
											<div class="form-group">
												<label for="exampleSelect1">Encargado de laboratorio</label>
												<select class="form-control" id="exampleSelect1" name="Id_tipo_de_usuario">
													<option value="1">Yarely Baéz Lopez</option>
													<option value="2">Jarmen Said</option>
												</select>
											</div>
										</div>
